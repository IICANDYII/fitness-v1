...
EXERCISE_MUSCLES: dict[str, dict[str, list[str]]] = {
    ...
    "坐姿划船":   {"primary": ["lats", "traps"],        "secondary": ["biceps", "rear-shoulders"]},
    "杠铃划船":   {"primary": ["lats", "traps"],        "secondary": ["biceps", "lowerback"]},
    "哑铃划船":   {"primary": ["lats"],                        "secondary": ["biceps", "rear-shoulders"]},
    "绳索划船":   {"primary": ["lats", "traps"],        "secondary": ["biceps"]},
    "面拉":       {"primary": ["rear-shoulders", "traps"], "secondary": []},
